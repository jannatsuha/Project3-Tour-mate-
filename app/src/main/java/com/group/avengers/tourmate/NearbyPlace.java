...
public class NearbyPlace extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, com.google.android.gms.location.LocationListener{
    ...
    private List<NearbyByPlaceContent> nearbyByPlaceContents=new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnFind.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String placeUrl=String.format("json?location=%f,%f&radius=500&type=$s&key=%s",userPrferences.getLastLocationLongitude(),userPrferences.getLastLocationLatitude(),itemCatagoryPosition,api_key);
